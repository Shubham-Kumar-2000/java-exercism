class TwelveDays { 
    String[] giftStrings ={"On the first day of Christmas my true love gave to me: a Partridge in a Pear Tree.\n"
    ,
    ...
    String verse(int verseNumber) {
        return giftStrings[verseNumber-1];
    }

    String verses(int startVerse, int endVerse) {
        String song = "";
        for (int i = startVerse; i <= endVerse; i++) {
            song += verse(i) + (i==endVerse ? "" : "\n");
        }
        return song;
    }
